...
from ..bbox_utils import log_sum_exp, match_ssd,match
from ..bbox_utils import match_ssd_ious,bbox_overlaps_iou, bbox_overlaps_giou, bbox_overlaps_diou, bbox_overlaps_ciou, decode
...
class MultiBoxLoss_ssd(nn.Module):
    ...
    def __init__(self, cfg, dataset, use_gpu=True):
        super(MultiBoxLoss_ssd, self).__init__()
    ...
    def forward(self, predictions, targets):
        ...
        for idx in range(num):
            ...
            if self.loss == 'SmoothL1':
                ...
                match_ssd_ious(self.threshold, truths, defaults, self.variance, labels,
                    loc_t, conf_t, idx)
        ...
        loss_c = self.focalloss(batch_conf,targets_weighted)
