...
parser.add_argument('--save_dir', type=str, default='/content/drive/MyDrive/repos/S3FD_RepVGG/tmp',
                    help='Directory for detect result')
parser.add_argument('--model', type=str,
                    default='S3FD_REPVGG_deploy.pth', help='trained model')
...
if __name__ == '__main__':
    ...
    checkpoint =torch.load(os.path.join(args.deploy_save,args.model))
    ...
    img_path = '/content/drive/MyDrive/repos/S3FD_RepVGG/img'
