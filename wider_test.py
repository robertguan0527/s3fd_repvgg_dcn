...
parser.add_argument('--model', type=str,
                    default='/content/drive/MyDrive/repos/S3FD_RepVGG/weights/model_best.pth', help='trained model')
parser.add_argument('--thresh', default=0.05, type=float,
                    help='Final confidence threshold')
parser.add_argument('--deploy_save',default= '/content/drive/MyDrive/repos/S3FD_RepVGG/weights',type = str,help ='deploy model save folder')
...
def get_data():
    ...
    save_path = '/content/drive/MyDrive/repos/S3FD_RepVGG/eval_tools/s3fd_{}'.format(subset)
...
if __name__ == '__main__':
 ...
 #  How to convert the train_model to an deploy model for test   
    ...
    net = repvgg_model_convert(train_net, save_path = os.path.join(args.deploy_save,'S3FD_REPVGG_deploy.pth'))
    ...
    checkpoint =torch.load(os.path.join(args.deploy_save,'S3FD_REPVGG_deploy.pth'))
    ...
    for index, event in enumerate(event_list):
        ...
        for num, file in enumerate(filelist):
            ...
            print(f"forward time is {t_end-t_start}")
